...
def create_sim(n_cells=100, n_pacemakers=3, seed=42, world_size=512, relay_radius=40.0, pulse_period=10) -> DictyosteliumSim:
...
def setup_dictyostelium_microscope(n_cells=100, n_pacemakers=3, seed=42, world_size=512, relay_radius=40.0, pulse_period=10):
    """Programmatic setup (no .cfg needed)."""
    sim = create_sim(n_cells=n_cells, n_pacemakers=n_pacemakers, seed=seed, world_size=world_size, relay_radius=relay_radius, pulse_period=pulse_period)
