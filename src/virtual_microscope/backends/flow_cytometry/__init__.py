...
def setup_flow_cytometry_microscope(n_total=10000, events_per_snap=100, seed=42):
    ...
    core.defineConfig("Fake", "scatter", "Detector", "Label", "FSC-SSC")
    core.defineConfig("Fake", "FITC", "Detector", "Label", "FL1-FITC")
    core.defineConfig("Fake", "PE", "Detector", "Label", "FL2-PE")
    core.setConfig("Fake", "scatter")
    return core, sim
